...
export const STRIPE_PRODUCTS: StripeProduct[] = [
  {
    ...
    priceId: 'price_1QZqGhP8dKNlGKJhXYZ123AB', // Replace with your actual Stripe weekly price ID
    price: 2.99,
    mode: 'subscription',
    currency: 'usd',
    interval: 'week',
  ...
  },
  {
    ...
    priceId: 'price_1QZqGhP8dKNlGKJhXYZ456CD', // Replace with your actual Stripe monthly price ID
    price: 9.99,
    mode: 'subscription',
    currency: 'usd',
    interval: 'month',
  ...
  },
  {
    ...
    priceId: 'price_1QZqGhP8dKNlGKJhXYZ789EF', // Replace with your actual Stripe yearly price ID
    price: 79.99,
    mode: 'subscription',
    currency: 'usd',
    interval: 'year',

...
import { trackDatabaseOperation, captureException, addBreadcrumb } from '@/lib/sentry';
...
export const userService = {
  async getProfile(userId: string) {
    return trackDatabaseOperation('select', 'users', async () => {
  ...
  async updateProfile(userId: string, updates: Partial<Tables['users']['Update']>) {
    return trackDatabaseOperation('update', 'users', async () => {
      const { data, error } = await supabase
        .from('users')
        .update(updates)
        .eq('id', userId)
  ...
  async createProfile(profile: Tables['users']['Insert']) {
    return trackDatabaseOperation('insert', 'users', async () => {
      const { data, error } = await supabase
        .from('users')
        .insert(profile)
        .select()
...
export const subscriptionService = {
  async getUserSubscription(userId: string) {
    return trackDatabaseOperation('select', 'user_subscriptions', async () => {
      const { data, error } = await supabase
  ...
  async createSubscription(subscription: Tables['user_subscriptions']['Insert']) {
    return trackDatabaseOperation('insert', 'user_subscriptions', async () => {
      const { data, error } = await supabase
        .from('user_subscriptions')
        .insert(subscription)
        .select()
  ...
  async updateSubscription(id: string, updates: Tables['user_subscriptions']['Update']) {
    return trackDatabaseOperation('update', 'user_subscriptions', async () => {
      const { data, error } = await supabase
        .from('user_subscriptions')
        .update(updates)
        .eq('id', id)
  ...
  async checkFeatureAccess(userId: string, featureKey: string) {
    return trackDatabaseOperation('rpc', 'check_feature_access', async () => {
      const { data, error } = await supabase
  ...
  async grantTrialAccess(userId: string) {
    return trackDatabaseOperation('rpc', 'grant_trial_access', async () => {
      const { data, error } = await supabase
  ...
  async getPremiumFeatures() {
    return trackDatabaseOperation('select', 'subscription_features', async () => {
      const { data, error } = await supabase
  ...
  async getUserFeatureAccess(userId: string) {
    return trackDatabaseOperation('select', 'user_feature_access', async () => {
      const { data, error } = await supabase
...
export const moodService = {
  async createMoodEntry(entry: Tables['mood_entries']['Insert']) {
    return trackDatabaseOperation('insert', 'mood_entries', async () => {
      addBreadcrumb('Creating mood entry', 'wellness', 'info');
      ...
      addBreadcrumb('Mood entry created successfully', 'wellness', 'info');
      return data;
    });
  },

  async getMoodEntries(userId: string, limit = 10) {
    return trackDatabaseOperation('select', 'mood_entries', async () => {
      const { data, error } = await supabase
        .from('mood_entries')
        .select('*')
        .eq('user_id', userId)
  ...
  async updateMoodEntry(id: string, updates: Tables['mood_entries']['Update']) {
    return trackDatabaseOperation('update', 'mood_entries', async () => {
      const { data, error } = await supabase
        .from('mood_entries')
        .update(updates)
        .eq('id', id)
  ...
  async deleteMoodEntry(id: string) {
    return trackDatabaseOperation('delete', 'mood_entries', async () => {
...
export const journalService = {
  async createJournalEntry(entry: Tables['journal_entries']['Insert']) {
    return trackDatabaseOperation('insert', 'journal_entries', async () => {
      addBreadcrumb('Creating journal entry', 'wellness', 'info');
      ...
      addBreadcrumb('Journal entry created successfully', 'wellness', 'info');
      return data;
    });
  },

  async getJournalEntries(userId: string, limit = 10) {
    return trackDatabaseOperation('select', 'journal_entries', async () => {
      const { data, error } = await supabase
        .from('journal_entries')
        .select('*')
        .eq('user_id', userId)
  ...
  async updateJournalEntry(id: string, updates: Tables['journal_entries']['Update']) {
    return trackDatabaseOperation('update', 'journal_entries', async () => {
      const { data, error } = await supabase
        .from('journal_entries')
        .update(updates)
        .eq('id', id)
  ...
  async deleteJournalEntry(id: string) {
    return trackDatabaseOperation('delete', 'journal_entries', async () => {
      const { error } = await supabase
        .from('journal_entries')
        .delete()
        .eq('id', id);
  ...
  async exportJournalData(userId: string) {
    return trackDatabaseOperation('select', 'journal_entries', async () => {
      addBreadcrumb('Exporting journal data', 'wellness', 'info');
      ...
      addBreadcrumb('Journal data exported successfully', 'wellness', 'info');
      return data;
    });
  }
};
...
export const plantService = {
  async createPlant(plant: Tables['plants']['Insert']) {
    return trackDatabaseOperation('insert', 'plants', async () => {
      addBreadcrumb('Creating new plant', 'wellness', 'info');
      ...
      addBreadcrumb('Plant created successfully', 'wellness', 'info');
      return data;
    });
  },

  async getPlants(userId: string) {
    return trackDatabaseOperation('select', 'plants', async () => {
      const { data, error } = await supabase
        .from('plants')
        .select('*')
        .eq('user_id', userId)
  ...
  async updatePlant(id: string, updates: Tables['plants']['Update']) {
    return trackDatabaseOperation('update', 'plants', async () => {
      const { data, error } = await supabase
        .from('plants')
        .update(updates)
        .eq('id', id)
  ...
  async deletePlant(id: string) {
    return trackDatabaseOperation('delete', 'plants', async () => {
      const { error } = await supabase
        .from('plants')
        .delete()
        .eq('id', id);
  ...
  async waterPlant(id: string) {
    return trackDatabaseOperation('update', 'plants', async () => {
      addBreadcrumb('Watering plant', 'wellness', 'info');
      ...
      addBreadcrumb('Plant watered successfully', 'wellness', 'info');
      return data;
    });
  },
  ...
  async sunlightPlant(id: string) {
    return trackDatabaseOperation('update', 'plants', async () => {
      addBreadcrumb('Giving plant sunlight', 'wellness', 'info');
      ...
      addBreadcrumb('Plant given sunlight successfully', 'wellness', 'info');
      return data;
    });
  },
...
export const wellnessService = {
  async createActivity(activity: Tables['wellness_activities']['Insert']) {
    return trackDatabaseOperation('insert', 'wellness_activities', async () => {
      addBreadcrumb(`Creating wellness activity: ${activity.activity_type}`, 'wellness', 'info');
      ...
      addBreadcrumb('Wellness activity created successfully', 'wellness', 'info');
      return data;
    });
  },

  async getActivities(userId: string, limit = 20) {
    return trackDatabaseOperation('select', 'wellness_activities', async () => {
      const { data, error } = await supabase
        .from('wellness_activities')
        .select('*')
        .eq('user_id', userId)
  ...
  async updateActivity(id: string, updates: Tables['wellness_activities']['Update']) {
    return trackDatabaseOperation('update', 'wellness_activities', async () => {
      const { data, error } = await supabase
        .from('wellness_activities')
        .update(updates)
        .eq('id', id)
  ...
  async completeActivity(id: string) {
    return trackDatabaseOperation('update', 'wellness_activities', async () => {
      addBreadcrumb('Completing wellness activity', 'wellness', 'info');
      ...
      addBreadcrumb('Wellness activity completed successfully', 'wellness', 'info');
      return data;
    });
  },

  async deleteActivity(id: string) {
    return trackDatabaseOperation('delete', 'wellness_activities', async () => {
      const { error } = await supabase
        .from('wellness_activities')
        .delete()
        .eq('id', id);
...
export const analyticsService = {
  async getDashboardData(userId: string) {
    try {
      addBreadcrumb('Loading dashboard data', 'analytics', 'info');
      ...
      addBreadcrumb('Dashboard data loaded successfully', 'analytics', 'info');
      ...
      captureException(error as Error, { analytics: { operation: 'getDashboardData', userId } });
      throw error;
    }
  },
  ...
  async getWeeklyMoodData(userId: string) {
    try {
      ...
      captureException(error as Error, { analytics: { operation: 'getWeeklyMoodData', userId } });
      throw error;
    }
  },
  ...
  async getAdvancedAnalytics(userId: string) {
    try {
      addBreadcrumb('Loading advanced analytics', 'analytics', 'info');
      ...
      addBreadcrumb('Advanced analytics loaded successfully', 'analytics', 'info');
      ...
      captureException(error as Error, { analytics: { operation: 'getAdvancedAnalytics', userId } });
      throw error;
    }
  },
  ...
  async getMoodPrediction(userId: string) {
    try {
      ...
      captureException(error as Error, { analytics: { operation: 'getMoodPrediction', userId } });
      throw error;
    }
  }
};
